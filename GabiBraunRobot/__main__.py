...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD KATAKURI TO YOUR GROUP ➕️",url="t.me/KatakuriXMonsterBot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [     InlineKeyboardButton(
            text="🎦 Anime Channel", url="https://t.me/TheRealmOfWeebs"),
    
    ],
    [
        InlineKeyboardButton(
            text="📮 Update Channel", url="https://telegram.dog/RealmBotSupport"),
    ],
    [
        InlineKeyboardButton(
            text="📑 Loges", url="https://t.me/KatakuriLog"),
          


InlineKeyboardButton(
            text="🐱 SUPPORT", url="https://telegram.dog/RealmBotSupport"
        ),
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paytm](#) or by contacting @MonsterKatakuri\
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Katakuri*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about *Katakuri*, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
