...
class Config(object):
    ...
    JOIN_LOGGER = -1001758835660  #Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -1001873860909  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit

    #RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgres://etdiqawv:S-_PRj7jd90sCBfbei3L-WyFEQfkiMwB@castor.db.elephantsql.com/etdiqawv' # needed for any database modules
    REDIS_URI = "redis://Ghouls:7518@Sidd@redis-16548.c305.ap-south-1-1.ec2.cloud.redislabs.com:16548/hehehehe"
    LOAD = []
    ...
    BAN_STICKER = 'CAACAgIAAxkBAAEI-_pkYiZZsycrfBrf9s18hXls0CXWDQACNSEAAj9jeUg2fyEu2Fwr3C8E'  # banhammer marie sticker id, the bot will send this sticker before banning or kicking a user in chat.
    ALLOW_EXCL = True  # Allow ! commands as well as / (Leave this to true so that blacklist can work)
    CASH_API_KEY = 'TCYFLC8EVUBR8QLM'  # Get your API key from https://www.alphavantage.co/support/#api-key
